...
def fetch_recent_papers(requested_date):
    try:
        ...
        logging.info("Start of interval: " + str(target_date_start))
        logging.info("End of interval: " + str(target_date_end))
        ...
        logging.info("Scraping arxiv.org for papers from %s to %s", target_date_start, target_date_end)
